    ...
    <div class="h-screen  flex  justify-start ">
        <sidebar class="w-[17vw] bg-gray-800 shadow-2x text-white divide-y divide">
            ...
            <div class="flex flex-col justify-center  content-center items-center ">
                <h1 class="p-[2rem] text-[13px] ">MENU ALUMNO</h1>
                <div class=" w-[80%] flex flex-col gap-[2rem]">
                    ...
                    <button class="flex gap-4 text-[13px] items-center"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        ...
                        <h1><a href="/admAlumnoMaestro">Alumnos</a></h1>
                    </button>
...
<div><span class="material-symbols-outlined">
        ...
        <p> Logout</p>
                ...
                <div class="bg-white shadow-xl flex flex-col h-[90vh] w-[80vw] mx-[1rem] content-center rounded-xl p-[1rem] justify-center m-[2rem]">
...
<form method="post" action="/editarPefilalumno" class="flex justify-center content-center items-center flex-col gap-[2rem] bg-white ">
<h1 class="text-[2rem]">Editar  Maestro</h1>


<div class="flex flex-col gap-[2rem]">
<label>Correo Electronico</label>
<input class="border-2 border-solid h-[5vh]" type="email"  name="email" value="<?=$correo?>" require/>

<label>Nombre(s)</label>
<input class="border-2 border-solid h-[5vh]" type="text"  name="nombre" value="<?=$nombre?>" require/>
<div>

<div class="flex flex-col gap-[2vh]">
<label>Apellido(s)</label>
<input class="border-2 border-solid h-[5vh]"  type="text"  name="apellido" value="<?=$Apellido?>"require/>

<label>Direccion</label>
<input class="border-2 border-solid h-[5vh]" type="text"  name="direccion" value="<?=$direccion?>" require/>
<div>

<div class="flex m-[1rem]">
<label>Fecha de Nacimiento</label>
<input class="border-2 border-solid h-[5vh]" type="date" name="fecha" value="<?=$fec_nac?>" require/>
...
<button class="bg-blue-500 text-white  w-[100%] h-[5vh]  text-center">Guardar Cambios</button></div>
