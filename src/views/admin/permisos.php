        ...
        <sidebar class="w-[17vw] bg-gray-800 shadow-2x text-white divide-y divide">
            ...
            <div class="flex flex-col justify-center  content-center items-center ">
                ...
                <div class=" w-[80%] flex flex-col gap-[2rem]">
                    ...
                    <button class="flex gap-4 text-[13px] items-center"><span class="material-symbols-outlined">
                            jamboard_kiosk
                        </span>
                        <h1>Clases</h1>
                    </button>
...
<div><span class="material-symbols-outlined">
 ...
 <tr>
      <td class="border text-center border-slate-700 ..."> $Nombre ? $ID_empleado ?</td>
      <td class="border text-center border-slate-700 ..."> $correo ?</td>
      <td class="border text-center border-slate-700 ...">$direccion </td>
